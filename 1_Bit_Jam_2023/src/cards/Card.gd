...
enum CardName { ATTACK_SWORD, DEFEND_HELMET, HEAL_HEART, HEAL_HEALTH_POTION, DEFEND_SPECIAL_KNIGHT_HELMET, DEFEND_HOOD, ATTACK_STAFF, ATTACK_SCYTHE, ATTACK_NUKE, ATTACK_CLUB }
